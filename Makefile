CC = gcc
FLAGS = -Wall
OBJECTS = ArbreQuat.o Chaine.o ChaineMain.o Hachage.o ReconstitueReseau.o Reseau.o SVGwriter.o ArbreQuat.o main.o GenerationAleatoireMain.o
PROGRAMS = ChaineMain ReconstitueReseau main GenerationAleatoireMain
